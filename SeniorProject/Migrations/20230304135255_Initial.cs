        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonorNameOrTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MemberID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventID = table.Column<int>(type: "int", nullable: false),
                    MemberSenderMemberID = table.Column<int>(name: "Member_SenderMemberID", type: "int", nullable: false),
                    MemberIDSender = table.Column<int>(name: "MemberID_Sender", type: "int", nullable: false),
                    MemberRecieverMemberID = table.Column<int>(name: "Member_RecieverMemberID", type: "int", nullable: false),
                    MemberIDReciever = table.Column<int>(name: "MemberID_Reciever", type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventInvitations_Members_Member_RecieverMemberID",
                        column: x => x.MemberRecieverMemberID,
                        principalTable: "Members",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_EventInvitations_Members_Member_SenderMemberID",
                        column: x => x.MemberSenderMemberID,
                        principalTable: "Members",
                        principalColumn: "MemberID",
                        onDelete: ReferentialAction.NoAction);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventInvitations_Member_RecieverMemberID",
                table: "EventInvitations",
                column: "Member_RecieverMemberID");

            migrationBuilder.CreateIndex(
                name: "IX_EventInvitations_Member_SenderMemberID",
                table: "EventInvitations",
                column: "Member_SenderMemberID");
